    ...
    <View style={styles.container}>
      <View style={styles.inputContainer}>
        <View style={styles.inputStyle}>
          ...
          <TextInput style={styles.inputTextField} value={email} onChangeText={setEmail} placeholder='Användarnamn'></TextInput>
        </View>
        <View style={styles.inputStyle}>
          <Text style={styles.inputLabel}>Lösenord</Text>
          <TextInput style={styles.inputTextField} value={password} onChangeText={setPassword}  placeholder='Lösenord'></TextInput>
        </View>
      </View>
